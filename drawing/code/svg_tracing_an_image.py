...
if __name__ == '__main__':
    ...
    # recommended velocity = 40
    velocity = 40
    # recommended acceleration = 200
    acceleration = 200
    # recommended jerk = 2000
    jerk = 2000
    ...
    cmds, cmds_length = svg(10).gen('dog.svg', width, length, 0, 0, T, B, cp, scale, velocity, acceleration, jerk, corner)
    command_list = []
